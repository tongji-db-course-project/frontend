...
const effectivePrice = (product: CheckoutProduct) => product.isPromotion === '是' && product.promotionPrice != null
...
const memberRate = computed(() => member.value?.levelName === '钻石会员' || member.value?.levelName === '钻石'
  ? 0.9
